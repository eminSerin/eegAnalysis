...
for channel = 1: datasize(1)
    for trial = 1: datasize(3)
        temp = abs(fft(EEG.data(channel,:,trial)).^2/Fs);
...
print(fig,[path outputfilename,'.pdf'],'-dpdf')
...
newtimef(mean(EEG.data,1),...
    ...
    'freqs',[2 45],'plotitc','off','erspmax', [0 4],...
