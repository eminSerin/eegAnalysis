...
chanChange = 0; % Bypass broken channel.
if chanChange
...
EEG = pop_eegfiltnew(EEG, 1,100,1650,0,[],1); % filter data. 1 - 100 Hz.
...
%% Save preICA dataset.
pop_saveset( EEG, 'filename', [dataName, '_preICA'], 'filepath', eegpath);
